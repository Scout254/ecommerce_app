  ...
  return (
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        {popular.map((item) => (
          <div key={item.id} className="bg-white rounded-md overflow-hidden shadow-lg hover:shadow-xl transition duration-300 ease-in-out">
            ...
            <div className="p-4 text-center">
              ...
              <button onClick={() => addToBasket(item.id, item.image, item.price,item.name)} className="bg-purple-600 text-white font-semibold py-2 px-4 rounded-md hover:bg-purple-700 transition duration-300 ease-in-out">
                Add to Cart
              </button>
            </div>
          </div>
